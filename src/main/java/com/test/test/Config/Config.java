...
public class Config implements RabbitListenerConfigurer{
    ...
    private final String QUEUE_NAME = "animals";
    private final String DIRECT_EXANGE = "animals.exchange";
    ...
    public DirectExchange directExchange(){
        return new DirectExchange(DIRECT_EXANGE);
    }

    //Binding de queue normal al direct exchange
    @Bean
    public Binding bindQueue(Queue queue){
